...
public class BotSendPayload {
    ...
    public BotSendPayload(Long id, String name, String deploymentDestination, String botType, FacebookSpecPayload facebookSpec, SlackSpecPayload slackSpecPayload, TelegramSpecPayload telegramSpecPayload) {
        this.id = id;
        this.name = name;
